...
extension Logger {
  ...
  ///   - fileID: The fileID where this method was called, this is used for automatically extracting the module name, this should not be overridden.
  ...
  public func tracing<R>(
    ...
    do {
      ...
      debug("End: \(message) | Success: \(output)")
      return result
    } catch {
      debug("End: \(message) | Failure: \(error.localizedDescription)")
      throw error
    }
  }
